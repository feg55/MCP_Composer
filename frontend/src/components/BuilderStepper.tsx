          ...
          return (
            <li key={step.id}>
              <button
                ...
                className={cn(
                  "flex min-h-[76px] w-full items-start gap-3 rounded-md border px-3 py-3 text-left transition",
              ...
              >
                ...
                <span className="min-w-0">
                  <span className="flex flex-wrap items-center gap-2 text-[13px] font-semibold text-[#e7ece7]">
                    {step.label}
                    {typeof step.count === "number" && (
                      <span className="rounded-full border border-[#343d34] px-2 py-0.5 text-[11px] text-[#a9b4aa]">
                        {step.count}
                      </span>
                    )}
                  </span>
                  <span className="mt-1 block text-[12px] leading-4 text-[#a9b4aa]">{step.detail}</span>
                </span>
              </button>
            </li>
          );
