              ...
              <article key={server.id} className="rounded-lg border border-[#343d34] bg-[#202620] p-4">
                <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
                  <div className="min-w-0">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2 text-[12px] text-[#a9b4aa]">
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:justify-end">
                    <Button variant="secondary" onClick={() => onToggleDisabled(server.id)} leftIcon={<Power size={15} />}>
                    ...
                    <Button variant="danger" onClick={() => onRemove(server.id)} leftIcon={<Trash2 size={15} />}>
                      Remove
                    </Button>
                  </div>
                </div>
